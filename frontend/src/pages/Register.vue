  ...
  <div class="register-container">
    ...
    <div class="register-brand-section">
      <div class="brand-content">
        <h1 class="brand-title">AI Travel Planner</h1>
        <p class="brand-subtitle">开启您的智能旅行体验</p>
        <div class="brand-features">
          <div class="feature-item">
            <div class="feature-icon">✈️</div>
            <span>AI 驱动的行程规划</span>
          </div>
          <div class="feature-item">
            <div class="feature-icon">🗺️</div>
            <span>智能路线推荐</span>
    ...
    <div class="register-form-section">
      <div class="register-form-wrapper">
        <div class="form-header">
          ...
          <p class="register-subtitle">加入我们，开始您的智能旅行规划之旅</p>
        </div>
        <AuthForm 
          mode="register" 
          @switch-mode="handleSwitchToLogin"
          @auth-success="handleAuthSuccess"
        />
        <div class="form-footer">
          <p>© 2025 AI Travel Planner. 保留所有权利。</p>
        </div>
      </div>
    </div>
  </div>
